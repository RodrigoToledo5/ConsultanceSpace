...
const sequelize = new Sequelize(
  ...
  "postgres://zngfqqxm:1RqQfyE1V8T9mfOdJj9_mwW5ODsPI2vm@motty.db.elephantsql.com/zngfqqxm",
  {
...
//// comprobantes de subcripcion
Profesional.hasMany(Pago)
Pago.belongsTo(Profesional)
